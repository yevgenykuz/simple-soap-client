...
* **Send SOAP requests**  - Sends a SOAP request XML and returns the response
...
.. code-block:: java
        ...
        // Create a client with for a specific SOAP operation
        ...
        // it, and fill the parameters you need), and get the response XML as string:
